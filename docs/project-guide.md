...
| 15-minute rule | `UrgePause.vue`, `UrgePauseService.js`, `Home.vue` | `UrgePauseController`, `UrgePauseService`, `UrgePauseScheduler`, `UrgePauseRepository` | Urge pause service/controller and Playwright tests; Coach BEHAVIOR context |
