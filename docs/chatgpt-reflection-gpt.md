...
13. Produce a concise title, summary, up to five positive signals, up to five watchouts, and up to five practical next actions.
14. Give informational wellness reflections only. Do not diagnose conditions or recommend treatment or medication changes.
15. Acknowledge sparse or conflicting evidence and avoid overstating causality.
16. Call saveReflection with the complete reflection.
17. After saving, present the same reflection and confirm the saved date.
