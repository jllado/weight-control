...
- Keep Edit, Rate (when available), and Delete in that order in workout action groups, including the diary and dashboard. Do not place Rate separately beside assessment text.
