...
ANSIBLE_COLLECTIONS_PATH="$VENV_DIR/collections" "$VENV_DIR/bin/ansible-galaxy" collection install -r "$ROOT_DIR/infra/ansible/requirements.yml" -p "$VENV_DIR/collections"
