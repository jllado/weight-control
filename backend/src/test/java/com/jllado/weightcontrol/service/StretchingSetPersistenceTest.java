...
class StretchingSetPersistenceTest {
    ...
    @Test void persistsOrderedHoldsScopesOwnersAndPreservesRecordedWorkouts() {
        ...
        var recorded = workouts.create(owner, new WorkoutRequest(java.time.LocalDate.of(2026, 9, 1), null, List.of(new WorkoutLineRequest(first.getId(), null, null, List.of(new WorkoutSegmentRequest(null, 30, null, null, null, null, null, null)))), null, null, null, null, null, null));
