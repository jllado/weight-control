      ...
      <Column headerStyle="width: 100px">
        <template #body="panel">
          <div class="action-group action-group--compact">
            <CompactAction icon="pi pi-pencil" @click="edit(panel.data)" aria-label="Edit" />
            <CompactAction icon="pi pi-trash" :action="() => remove(panel.data)" busyLabel="Deleting…" aria-label="Delete" destructive />
          </div>
        </template>
      </Column>
    </DataTable>
