<template>
  <div class="recipe-form">
    <SaveFields class="recipe-fields" :saving="saving">
...
export default {
  ...
  methods: {
    ...
    async save() {
      ...
      try { const result = await service.save(this.draft); this.snapshot = snapshot; this.saving = false; this.$emit('saved', result); }
...
<style scoped>
.recipe-form, .recipe-fields { display: flex; flex-direction: column; gap: 1rem; }
.recipe-fields > .p-button { align-self: flex-start; }
