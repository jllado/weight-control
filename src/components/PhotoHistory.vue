      ...
      <carousel :items-to-show="1.5" :transition="500" >
        <slide v-for="photo in this.photos" :key="photo">
          <div style="width: 450px">
            ...
            <div>
              <img :src="photo.photo_left" loading="lazy" style="width: 100%" v-if="photo_type == 'left'" />
              <img :src="photo.photo_front" loading="lazy" style="width: 100%" v-if="photo_type == 'front'" />
              <img :src="photo.photo_right" loading="lazy" style="width: 100%" v-if="photo_type == 'right'" />
            </div>
          </div>
        </slide>
